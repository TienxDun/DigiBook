...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-foreground text-white pt-8 pb-24 lg:pb-6">
      <div className="w-[92%] xl:w-[80%] 2xl:w-[60%] mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-premium text-white mb-6">Khám phá</h4>
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-premium text-white mb-6">Hỗ trợ khách hàng</h4>
            <ul className="space-y-3 text-sm font-bold text-slate-400">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-premium text-white mb-6">Đăng ký bản tin</h4>
            <p className="text-slate-400 text-sm mb-4 font-medium">Nhận ngay ưu đãi 10% cho đơn hàng đầu tiên và cập nhật sách mới hàng tuần.</p>
            <form className="relative">
              <input
                type="email"
                placeholder="Email của bạn..."
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-3 pl-4 pr-12 text-sm focus:border-primary focus:outline-none transition-all"
              />
              <button className="absolute right-1.5 top-1.5 bottom-1.5 w-9 bg-primary rounded-xl flex items-center justify-center hover:bg-primary/90 transition-all">
        ...
        <div className="pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex flex-col md:flex-row items-center gap-3 text-slate-500 text-xs font-bold uppercase tracking-premium text-center md:text-left">
            <span>© 2026 DigiBook. Cùng <i className="fa-solid fa-heart text-rose-500 mx-1"></i> cho người yêu sách.</span>
