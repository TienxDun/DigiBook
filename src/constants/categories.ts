...
export const AVAILABLE_ICONS = [
  'fa-book-open', 'fa-hat-wizard', 'fa-brain', 'fa-chart-line',
  'fa-landmark', 'fa-child', 'fa-heart', 'fa-star', 'fa-lightbulb',
  'fa-graduation-cap', 'fa-briefcase', 'fa-globe', 'fa-music', 'fa-camera',
  'fa-utensils', 'fa-palette', 'fa-microscope', 'fa-rocket', 'fa-ghost', 'fa-dna'
];
