          ...
          <table className="w-full text-left border-collapse min-w-[1200px]">
            <thead>
              <tr className={`border-b ${isMidnight ? 'bg-slate-900/50 border-white/5' : 'bg-muted/30 border-border'}`}>
                ...
                <th className="px-4 py-5 text-xs font-bold text-muted-foreground uppercase tracking-wide min-w-[220px]">Thông tin sách</th>
                  ...
                  <td className="px-4 py-4 max-w-[250px]">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="min-w-0">
                        <h3 className="font-bold text-sm mb-1 line-clamp-2 text-foreground leading-tight" title={book.title}>{book.title}</h3>
