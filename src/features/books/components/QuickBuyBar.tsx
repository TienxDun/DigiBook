        ...
        <AnimatePresence>
            {show && (
                <motion.div
                    ...
                    className={`fixed left-0 lg:left-1/2 z-[100] w-full lg:w-[95%] lg:max-w-4xl px-4 lg:px-0 transition-all duration-300 ${scrolled ? 'bottom-28 lg:bottom-6' : '-bottom-40 lg:-bottom-20'
                        }`}
                >
