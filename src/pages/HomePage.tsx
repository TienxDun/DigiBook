...
const HomePage: React.FC<{ onQuickView?: (book: Book) => void }> = ({ onQuickView }) => {
  ...
  return (
    <div className="space-y-0 fade-in">
      ...
      <section className="sticky top-[64px] lg:top-[64px] z-40 py-2 lg:py-2 transition-all duration-500">
        <div className="max-w-7xl mx-auto px-4">
          <div className="bg-slate-900/95 backdrop-blur-2xl rounded-2xl lg:rounded-[2rem] border border-white/10 p-1.5 lg:p-2 shadow-[0_25px_50px_-12px_rgba(99,102,241,0.4)] flex items-center gap-2 lg:gap-3 overflow-hidden">
            <div className="flex-shrink-0 flex items-center gap-2.5 pl-4 pr-5 border-r border-white/10 mr-1">
        ...
        <div className="max-w-7xl mx-auto px-4 relative">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 lg:gap-8 mb-12 lg:mb-16">
            <div className="max-w-xl text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-primary/5 rounded-lg mb-4">
                <i className="fa-solid fa-wand-magic-sparkles text-primary text-micro"></i>
                <p className="text-micro font-bold text-primary uppercase tracking-premium">Curated For You</p>
              </div>
              <h2 className="text-3xl lg:text-5xl font-extrabold text-foreground tracking-tight leading-tight">Sách mới nhất <span className="text-primary">hôm nay</span>.</h2>
            </div>
