        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col lg:flex-row items-center gap-10 pt-16 pb-6 lg:pt-20">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <Link to="/category/Tất cả sách" className="w-full sm:w-auto px-7 py-3.5 bg-slate-900 text-white rounded-xl font-bold uppercase tracking-premium hover:bg-indigo-600 transition-all shadow-xl shadow-slate-900/10 active:scale-95 text-xs">
                Khám phá ngay
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="md:col-span-2 bg-indigo-900 rounded-3xl p-6 relative overflow-hidden group">
               ...
               <div className="relative z-10 flex items-center justify-between h-full">
                  <div>
                    <span className="text-micro font-black text-indigo-400 uppercase tracking-[0.2em] mb-2 block">Chào mừng bạn mới</span>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 lg:grid-cols-6 grid-rows-none auto-rows-fr gap-3 lg:gap-4 lg:h-[450px]">
            ...
            <div className="col-span-1 bg-amber-50 rounded-[2rem] p-5 flex flex-col items-center justify-center text-center group hover:bg-amber-100 transition-colors">
              ...
              <span className="text-xs font-black text-slate-900 uppercase">Flash Sale</span>
            ...
            <div className="col-span-1 bg-emerald-50 rounded-[2rem] p-5 flex flex-col items-center justify-center text-center group hover:bg-emerald-100 transition-colors">
              ...
              <span className="text-xs font-black text-slate-900 uppercase">Free Ship</span>
            ...
            <div className="col-span-1 bg-slate-50 rounded-[2rem] p-5 flex flex-col items-center justify-center text-center group hover:bg-slate-200 transition-colors">
               ...
               <span className="text-xs font-black text-slate-900 uppercase">Cộng đồng</span>
      ...
      <section className="py-12 lg:py-16 bg-slate-50/50 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 lg:gap-8 mb-12 lg:mb-16">
            <div className="max-w-xl text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-rose-50 rounded-lg mb-4">
                <i className="fa-solid fa-wand-magic-sparkles text-rose-500 text-micro"></i>
                <p className="text-micro font-bold text-rose-500 uppercase tracking-premium">Curated For You</p>
              </div>
            ...
            <Link to="/category/Tất cả sách" className="hidden md:flex text-indigo-600 font-bold text-xs uppercase tracking-premium items-center gap-2 group">
          ...
          <div className="mt-12 flex justify-center md:hidden">
             <Link to="/category/Tất cả sách" className="px-6 py-3 bg-white border border-slate-200 text-slate-900 rounded-xl font-bold text-xs uppercase tracking-premium shadow-sm active:scale-95 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4">
           <div className="bg-slate-900 rounded-[2.5rem] lg:rounded-[4rem] p-8 lg:p-16 flex flex-col lg:flex-row items-center gap-10 lg:gap-12 relative overflow-hidden">
              ...
              <div className="flex-1 relative z-10 text-center lg:text-left">
                 <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 rounded-full mb-6 text-indigo-300 text-xs font-bold uppercase tracking-premium">
                 ...
                 <button className="w-full sm:w-auto px-8 py-4 bg-indigo-600 text-white rounded-xl font-bold uppercase tracking-premium hover:bg-white hover:text-slate-900 transition-all active:scale-95 text-xs">
                    Đăng ký thành viên
                 </button>
              </div>
