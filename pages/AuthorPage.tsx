...
const AuthorPage: React.FC<AuthorPageProps> = ({ onAddToCart }) => {
  ...
  return (
    <div className="container mx-auto px-6 py-12 lg:py-20 fade-in">
      <div className="bg-slate-900 rounded-[3.5rem] p-10 lg:p-16 mb-20 relative overflow-hidden text-white">
      ...
      <h2 className="text-3xl font-extrabold text-slate-900 mb-10">Tác phẩm của {authorName}</h2>
