  ...
  return (
    <div className="w-[92%] xl:w-[60%] mx-auto px-4 py-12 lg:py-20 fade-in">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-4">
        <div>
          <p className="text-micro font-bold uppercase tracking-premium text-indigo-600 mb-2">Bộ sưu tập cá nhân</p>
          <h1 className="text-2xl lg:text-3xl font-extrabold text-slate-900 tracking-tight mb-1">Sách yêu thích</h1>
      ...
      {wishlist.length > 0 ? (
        ...
        <div className="py-32 text-center bg-white rounded-[3rem] border-2 border-dashed border-slate-100">
          ...
          <h3 className="text-2xl font-extrabold text-slate-900 mb-2 uppercase tracking-premium">Danh sách trống</h3>
          ...
          <Link to="/" className="px-10 py-4 bg-indigo-600 text-white rounded-2xl font-extrabold uppercase tracking-premium text-micro hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-100 inline-block">
            Xem tất cả sách
          </Link>
        </div>
      )}
